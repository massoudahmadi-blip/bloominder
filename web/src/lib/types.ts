...
export interface CommuneProfile {
  ...
  livability: { schools: number | null; ecoles: number | null; colleges: number | null; lycees: number | null; education_prioritaire: boolean | null; crime_rate: number | null; health_equip: number | null; transport_equip: number | null } | null;
